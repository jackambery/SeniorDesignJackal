...
class VelocityWithCovariance {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float32(obj.covariance, buffer, bufferOffset, 9);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.covariance = _arrayDeserializer.float32(buffer, bufferOffset, 9)
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'a09860a7c5148bbb104e36a1b6b45955';
  }
